...
#Crea el marco
marco = tk.Tk()
marco.title("max - metodo grafico")
marco.geometry("700x400")
marco.iconbitmap("")
marco.configure(background="#5DA0FF")
marco.config(bg="seashell4")
#Etiquetas
lbl1 = tk.Label(marco, text = "Función objetivo: ")
lbl1.pack()
lbl1.configure(background="seashell4")
lbl1.place(x = 0, y = 30)

lbl2 = tk.Label(marco, text = "X      +")
lbl2.pack()
lbl2.configure(background="seashell4")
lbl2.place(x = 230, y = 30)

lbl3 = tk.Label(marco, text = "Y")
lbl3.pack()
lbl3.configure(background="seashell4")
lbl3.place(x = 380, y = 30)

lbl4 = tk.Label(marco, text = "Maximizar o Minimizar")
lbl4.pack()
lbl4.configure(background="seashell4")
lbl4.place(x = 530, y = 30)

lbl5 = tk.Label(marco, text = "Digite el numero de inecuaciones: ")
lbl5.pack()
lbl5.configure(background="seashell4")
lbl5.place(x = 0, y = 90)

lbl6 = tk.Label(marco, text = "")
lbl6.pack()
lbl6.configure(background="seashell4")
lbl6.place(x = 100, y = 350)

lbl7 = tk.Label(marco, text = "Coef. X")
lbl7.pack()
lbl7.configure(background="seashell4")
lbl7.place(x = 100, y = 120)

lbl8 = tk.Label(marco, text = "Coef. Y")
lbl8.pack()
lbl8.configure(background="seashell4")
